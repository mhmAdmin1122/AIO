        ...
        <div className="dicslaimer-container">
          ...
          <div className="disclaimerLines">
            <div className="disclaimerAbout">
              ...
              at hasaanmumtaz6@gmail.com.</p> <br />
              <h1>
                <b>Disclaimers for AIO</b>
              </h1>
              <p>All the information on this website - www.aioass.techa - is
              published in good faith and for general information purpose only.
              AIO does not make any warranties about the completeness,
              reliability and accuracy of this information. Any action you take
              upon the information you find on this website {"(AIO)"}, is
              strictly at your own risk. AIO will not be liable for any losses
              and/or damages in connection with the use of our website. From our
